import TermsLayout from '@/pages/term/layout';
            ...
            <main>
                <section className="page-header bg-tertiary">
                    ...
                    <div className="row">
                        ...
                        <h2 className="mb-3 text-capitalize">Syarat &amp; Ketentuan</h2>
                        <ul
                ...
                <section className="section-sm">
                    ...
                    <div className="row">
                        ...
                        <div className="content">
                            <h3 id="the-use-of-the-information">Penggunaan Informasi</h3>
                            <ul>
                            <li>
                                Penggunaan informasi yang tepat dan bijaksana, demi melindungi
                                privasi dan keamanan data pengguna.
                            </li>
                            <li>
                                Informasi pengguna digunakan untuk meningkatkan layanan dan
                                pengalaman pengguna secara keseluruhan, sejalan dengan proses
                                pengembangan yang sedang berlangsung
                            </li>
                            </ul>
                            <h3 id="application-processing">Pemrosesan pembayaran</h3>
                            <ul>
                            <li>
                                Prosesing pembayaran masih dalam tahap pengembangan oleh tim
                                developer kami untuk memastikan keamanan dan kinerja yang
                                optimal.
                            </li>
                            <li>
                                Kami berkomitmen untuk menyediakan pengalaman pembayaran yang
                                terintegrasi dan aman bagi para pengguna saat platform kami
                                mencapai tahap matang.
                            </li>
                            </ul>
                            <h3 id="what-services-we-render">
                            Layanan Apa Yang Kami Berikan Terhadap Pengguna
                            </h3>
                            <p>
                            Pemrosesan pembayaran saat ini masih dalam tahap pengembangan oleh
                            tim developer kami untuk memastikan layanan yang handal dan
                            berkualitas tinggi. Selama fase ini, kami mengusahakan agar
                            pengguna dapat merasakan kemudahan dalam melakukan transaksi
                            dengan keamanan yang terjamin. Selain itu, kami juga tengah
                            menggalang dana pengembangan untuk mempercepat proyek ini,
                            sehingga kami dapat menyediakan pengalaman pembayaran yang semakin
                            canggih dan dapat diandalkan ketika platform kami mencapai tahap
                            matang.
                            </p>
                            <ul>
                            <li>
                            ...
                            <li>
                                Selama fase pengembangan, pemrosesan pembayaran menggunakan
                                Midtrans hanya berfungsi pada mode sandbox untuk menguji dan
                                menyempurnakan sistem sebelum diluncurkan secara resmi.
                            </li>
                            <li>
                                Dengan adanya penggunaan Midtrans dalam mode sandbox, kami dapat
                                mengoptimalkan dan memastikan kinerja serta kehandalan sistem
                                pembayaran sebelum platform Crowdfunding ini benar-benar siap
                                untuk digunakan secara live.
                            </li>
                            </ul>
                            <h3 id="intellectual-property-rights">Hak kekayaan intelektual</h3>
                            <ul>
                            <li>
                                Hak kekayaan intelektual dalam skripsi ini dihormati dan
                                dilindungi untuk memastikan keaslian dan kontribusi akademik
                                yang jelas.
                            </li>
                            <li>
                                Copyright dan alur hak cipta masih dalam tahap pengembangan dan
                                pengujian untuk memenuhi persyaratan akademik dan legalitas.
                            </li>
                            <li>
                                Skripsi ini saat ini hanya digunakan untuk pengujian di
                                lingkungan kampus dan tidak digunakan secara komersial atau
                                untuk tindakan ilegal.
                            </li>
                            <li>
                                Penggunaan skripsi ini dibatasi sesuai dengan pedoman dan aturan
                                kampus demi menjaga integritas dan keabsahan penelitian.
                            </li>
                            <li>
                                Dalam pengujian ini, kami berkomitmen untuk menaati aturan dan
                                etika akademik serta melindungi hak kekayaan intelektual yang
