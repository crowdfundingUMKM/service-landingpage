            ...
            <section className="section">
                ...
                <div className="row">
                    ...
                    <div className="me-lg-4">
                        ...
                        <div className="article col-md-6" data-aos="fade">
                            ...
                            <div className="pt-4">
                                ...
                                {/* target to id donate */}
                                <a href="campaign-details.html#donate">
                        ...
                        <div className="col-12">
                            ...
                            <nav className="mb-md-50">
                                ...
                                <li className="page-item active ">
                                    <a href="list-campaign.html" className="page-link">
                                    1
                                    </a>
                                </li>
                    ...
                    <div className="widget widget-categories">
                        ...
                        <li>
                            <a href="#!">
                            Makanan dan Minuman <small className="ml-auto">(1)</small>
                            </a>
                        </li>
                        <li>
                            <a href="#!">
                            Bisnis <small className="ml-auto">(2)</small>
                            </a>
                        </li>
                        <li>
                            <a href="#!">
                            Dagangan <small className="ml-auto">(1)</small>
                            </a>
                        </li>
                        <li>
                            <a href="#!">
                            Exportir <small className="ml-auto">(2)</small>
                            </a>
                        </li>
                        </ul>
                    </div>
