            ...
            <div className="col-lg-6 mb-5 mb-lg-0">
              <div className="block text-center text-lg-start pe-0 pe-xl-5">
                <h1 className="text-capitalize mb-4">
                  Melalui investasi crowdfunding, mari memsejahterakan perindustrian
                  dan dapatkan keuntungan
                </h1>
                <p className="mb-4">
                  Dengan mengajak untuk melakukan investasi pada crowdfunding
                  <br />
                  kita dapat memberikan dukungan kepada para pelaku usaha UMKM agar
                  dapat meningkatkan kesejahteraan industri kecil dan menengah,
                  sambil juga mendapatkan peluang keuntungan yang beragam.
                </p>
                {/* Rm data-bs-toggle & data target */}
                <Link
                  type="button"
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="section-title pt-4">
                ...
                <h1>Layanan Sistem Crowdfunding</h1>
                <p>Bagaimana Layanan Kami Bekerja pada Sitem CrowdFunding UMKM</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 service-item">
              <Link className="text-black" href="/service/campaign">
                <div className="block">
                  <span className="colored-box text-center h3 mb-4">01</span>
                  <h3 className="mb-3 service-title">Pemilik UMKM</h3>
                  <p className="mb-0 service-description">
                    Pemilik UMKM akan mengajukan permodalan yang akan di review oleh
                    para ahlinya.
                  </p>
                </div>
              </Link>
            ...
            <div className="col-lg-4 col-md-6 service-item">
              <Link className="text-black" href="/service/reviewer">
                <div className="block">
                  <span className="colored-box text-center h3 mb-4">02</span>
                  <h3 className="mb-3 service-title">Konsultan UMKM</h3>
                  <p className="mb-0 service-description">
                    Konsultan yang akan mereview atau approve permodalan akan di
                    pilih secara langsung sesuai dengan kapasitas mereka.
                  </p>
                </div>
              </Link>
            </div>
            <div className="col-lg-4 col-md-6 service-item">
              <Link className="text-black" href="/service/investor">
                <div className="block">
                  <span className="colored-box text-center h3 mb-4">03</span>
                  <h3 className="mb-3 service-title">Investor UMKM</h3>
                  <p className="mb-0 service-description">
                    Mereka yang telah menanam modal akan mendapatkan keuntungan
            ...
            <div className="col-lg-4 col-md-6 service-item">
              <Link className="text-black" href="/midtrans-terms">
                <div className="block">
                  {" "}
                  <span className="colored-box text-center h3 mb-4">04</span>
                  <h3 className="mb-3 service-title">Sistem Pembayaran</h3>
                  <p className="mb-0 service-description">
                    Kami telah terintegrasi dengan midtrans, tentunya ini memudahkan
                    dalam memberi modal pada UMKM
                  </p>
                </div>
              </Link>
            </div>
            <div className="col-lg-4 col-md-6 service-item">
              <Link className="text-black" href="/how-it-work#benefit">
                <div className="block">
                  <span className="colored-box text-center h3 mb-4">05</span>
                  <h3 className="mb-3 service-title">Keuntungan CrowdFunding</h3>
                  <p className="mb-0 service-description">
                    Setiap UMKM yang telah mendapatkan keuntungan dapat membagi
                    imbal hasil sesuai dengan ketentuan yang berlaku.
                  </p>
                </div>
              </Link>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-5">
              <div className="section-title">
                ...
                <h1>Pendanaan Cepat &amp; Pembayaran Fleksibel</h1>
                <p className="lead mb-0 mt-4"></p>
                <p>
                  Dalam sistem Crowdfunding kami, telah terintegrasi dengan Midtran,
                  sehingga setiap pembayaran akan langsung diteruskan ke platform
                  Crowdfunding kami. Proses pencairan modal dilakukan dengan
                  transparan setelah melalui proses peninjauan oleh pengguna, dan
                  setiap dana akan dikelola dengan baik oleh tim Crowdfunding kami.
                </p>
                <p>
                  Investasi Anda akan disalurkan setelah kebutuhan para UMKM
                  terpenuhi atau modal yang diajukan telah tercapai. Ayo
                  berinvestasi pada aplikasi Crowdfunding UMKM yang dikembangkan
                  oleh pelaku usaha ini, dan bersama-sama dukung pertumbuhan serta
                  kesuksesan UMKM dengan transparansi dan efektivitas yang terjamin.
                </p>
                <p />{" "}
                <Link className="btn btn-primary mt-4" href="/service/investor">
            ...
            <div className="col-lg-5">
              <div className="section-title">
                ...
                <div className="content mb-0 mt-4">
                  <p>
                    Integrasi sistem Crowdfunding kami dengan Midtran yang
                    memungkinkan setiap pembayaran langsung masuk ke platform kami.
                    Selain itu, proses pencairan modal yang transparan setelah
                    melalui peninjauan pengguna dan pengelolaan dana yang baik oleh
                    tim Crowdfunding kami juga menjadi faktor yang membedakan.
                  </p>
                  <p>
                    Selain itu, investasi akan disalurkan setelah kebutuhan UMKM
                    terpenuhi atau modal tercapai, menjadikan kami sebagai pilihan
                    yang tepat untuk berinvestasi pada aplikasi Crowdfunding UMKM
                    yang kami kembangkan. Dengan bergabung bersama kami, Anda turut
                    mendukung pertumbuhan dan kesuksesan UMKM dengan tingkat
                    transparansi dan efektivitas yang terjamin.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="difference-of-us-item p-3 rounded mr-0 me-lg-4">
                <div className="d-block d-sm-flex align-items-center m-2">
                  ...
                  <div className="block">
                    <h3 className="mb-3">Proses Cepat Dan Aman</h3>
                    <p className="mb-0">
                      Dalam sistem Crowdfunding kami, kami menawarkan proses yang
                      cepat dan aman dalam mendukung kebutuhan investasi Anda.
                    </p>
                  </div>
                </div>
              </div>
              <div className="difference-of-us-item p-3 rounded mr-0 me-lg-4">
                <div className="d-block d-sm-flex align-items-center m-2">
                  ...
                  <div className="block">
                    <h3 className="mb-3">Pertanyaan Cepat Jawaban dari admin</h3>
                    <p className="mb-0">
                      {" "}
                      kami menyediakan layanan pertanyaan cepat dan jawaban langsung
                      dari admin untuk memberikan solusi instan bagi pengguna.
                    </p>
                  </div>
                </div>
              </div>
              <div className="difference-of-us-item p-3 rounded mr-0 me-lg-4">
                <div className="d-block d-sm-flex align-items-center m-2">
                  ...
                  <div className="block">
                    <h3 className="mb-3">Kami Berusaha Agar Mendapatkan Profit </h3>
                    <p className="mb-0">
                      Dalam sistem Crowdfunding kami, kami berkomitmen untuk
                      mencapai profitabilitas yang optimal. Terintegrasi dengan
                      Midtran, setiap pembayaran akan langsung diteruskan ke
                      platform Crowdfunding kami, memastikan kelancaran transaksi
                      dan potensi keuntungan yang dapat diperoleh.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8 mb-4">
              <div className="section-title text-center">
                ...
                <h1>Kenali Dasar-Dasar Penetapan Harga dan Pembayaran Sederhana</h1>
              </div>
            </div>
              ...
              >
                <li className="nav-item m-2" role="presentation">
                  ...
                  <a
                    ...
                    aria-selected="true"
                  >
                    Berapa Banyak yang Dapat Saya Terima?
                  </a>
                </li>
                <li className="nav-item m-2" role="presentation">
                  <a
                    ...
                    aria-selected="true"
                  >
                    Berapa Biayanya untuk Berinvestasi?
                  </a>
                </li>
                <li className="nav-item m-2" role="presentation">
                  {" "}
              ...
              >
                    ...
                    <div className="col-md-6 order-1 order-md-0">
                      <div className="content-block">
                        ...
                        <div className="content">
                          <p>
                            Dalam sistem Crowdfunding kami, Anda dapat menerima
                            sejumlah dana sesuai dengan investasi yang Anda berikan.
                            Setiap pembayaran akan langsung diteruskan ke platform
                            Crowdfunding kami melalui integrasi dengan Midtran.{" "}
                          </p>
                          <p>
                            Proses pencairan modal akan dilakukan dengan transparan
                            setelah melalui proses peninjauan oleh pengguna, dan
                            setiap dana akan dikelola dengan baik oleh tim
                            Crowdfunding kami. Investasi Anda akan disalurkan
                            setelah kebutuhan para UMKM terpenuhi atau modal yang
                            diajukan telah tercapai.{" "}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="row align-items-center">
                    <div className="col-md-6 order-1 order-md-0">
                      <div className="content-block">
                        ...
                        <div className="content">
                          <p>
                            Biaya untuk berinvestasi dalam sistem Crowdfunding kami
                            bervariasi tergantung pada jumlah yang Anda ingin
                            investasikan. Setiap pembayaran akan langsung diteruskan
                            ke platform Crowdfunding kami melalui integrasi dengan
                            Midtran.
                          </p>
                          <p>
                            {" "}
                ...
                >
                  <div className="row align-items-center">
                    <div className="col-md-6 order-1 order-md-0">
                      <div className="content-block">
                        <h3 className="mb-4">Bagaimana Saya Membayar?</h3>
                        <div className="content">
                          <p>
                            Untuk melakukan pembayaran, Anda dapat menggunakan
                            metode pembayaran yang tersedia di platform kami. Detail
                            tentang metode pembayaran akan dijelaskan lebih lanjut
                            saat Anda melakukan proses investasi. Kami menjamin
                            transparansi dan efektivitas dalam seluruh proses
                            pembayaran dan pengelolaan dana.
                          </p>
                          <p>
                            Ayo berinvestasi pada aplikasi Crowdfunding UMKM yang
                            telah dikembangkan oleh pelaku usaha ini, dan
                            bersama-sama kita dapat mendukung pertumbuhan serta
                            kesuksesan UMKM dengan transparansi dan kepercayaan yang
                            terjamin.
                          </p>
                        </div>
                      </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <div className="section-title text-center">
                ...
                <h1 className="mb-4">Dipercaya Oleh 1K+ Orang</h1>
                <p className="lead mb-0">
                  Dipercaya oleh lebih dari 1.000 orang untuk memberikan solusi dan
                  kepuasan dalam setiap layanan yang kami tawarkan
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="shadow rounded bg-white p-4 mt-4">
                <div className="d-block d-sm-flex align-items-center mb-3">
                  ...
                  <div className="mt-3 mt-sm-0 ms-0 ms-sm-3">
                    <h4 className="h5 mb-1">Rudi Salam</h4>
                    <p className="mb-0">Investor</p>
                  </div>
                </div>
                <div className="content">
                  Berinvestasi di Crowdfunding UMKM memberikan kepuasan dan
                  kepercayaan. Transparansi pembayaran dan pengelolaan dana yang
                  baik berdampak positif bagi pelaku usaha UMKM.
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 pt-1">
              <div className="shadow rounded bg-white p-4 mt-4">
                <div className="d-block d-sm-flex align-items-center mb-3">
                  ...
                  />
                  <div className="mt-3 mt-sm-0 ms-0 ms-sm-3">
                    <h4 className="h5 mb-1">Kane Wesker</h4>
                    <p className="mb-0">Pengusaha</p>
                  </div>
                </div>
                <div className="content">
                  Saya merasa senang dan terpercaya dalam berinvestasi melalui
                  platform Crowdfunding UMKM ini. Proses pembayaran yang transparan
                  dan pengelolaan dana yang baik memberikan dampak positif bagi para
                  pelaku usaha UMKM.
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 pt-1">
              <div className="shadow rounded bg-white p-4 mt-4">
                <div className="d-block d-sm-flex align-items-center mb-3">
                  ...
                  />
                  <div className="mt-3 mt-sm-0 ms-0 ms-sm-3">
                    <h4 className="h5 mb-1">Sarah Lyonar</h4>
                    <p className="mb-0">Investor</p>
                  </div>
                </div>
                <div className="content">
                  Berinvestasi melalui Crowdfunding UMKM sangat memuaskan. Proses
                  pencairan modal yang transparan dan kontribusi saya telah membantu
                  UMKM dalam memenuhi kebutuhan mereka.{" "}
                </div>
              </div>
            </div>
          </div>
