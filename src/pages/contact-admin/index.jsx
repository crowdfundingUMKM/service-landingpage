import ContactAdminLayout from '@/pages/contact-admin/layout';
            ...
            <main>
                <section className="page-header bg-tertiary">
                    ...
                    <div className="row">
                        ...
                        <h2 className="mb-3 text-capitalize">Kontak Admin Kami</h2>
                        <ul
                ...
                <section className="section">
                    ...
                    <div className="row justify-content-center align-items-center">
                        ...
                        <div className="section-title text-center">
                            ...
                            <h1>Hubungi Kami</h1>
                            <p>
                            Jangan ragu untuk menghubungi kami untuk pertanyaan, bantuan, atau
                        ...
                        <div className="shadow rounded p-5 bg-white">
                            ...
                            <div className="col-lg-6 mt-5 mt-lg-0">
                                ...
                                <div className="block mt-0">
                                    <h4 className="h5">Punya Pertanyaan?</h4>
                                    <div className="content">
                                    Hubungi Kami Kami Akan Dengan Senang Hati Membantu
                                    <br /> <a href="tel:+62812634561">+62812634561</a>
                                    <br />
                                    Senin - Minggu
                                    <br />9 Pagi - 10 Malam WIB
                                    </div>
                                </div>
                                <div className="block mt-4">
                                    <h4 className="h5">Indonesia</h4>
                                    <div className="content">
                                    Aceh,
                                    <br />
                                    Darusalam
