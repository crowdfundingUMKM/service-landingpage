            ...
            <main>
                <section className="page-header bg-tertiary">
                    ...
                    <div className="row">
                        ...
                        <h2 className="mb-3 text-capitalize">Tentang Kami</h2>
                        <ul
                ...
                <section className="section">
                    ...
                    <div className="row justify-content-center align-items-center">
                        ...
                        <div className="section-title">
                            ...
                            <h2 className="h1 mb-4">Crowdfunding UMKM</h2>
                            <div className="content pe-0 pe-lg-5">
                            <p>
                                Crowdfunding UMKM adalah platform inovatif yang berkomitmen
                                untuk mendukung pertumbuhan dan kesuksesan para pelaku usaha
                                UMKM. Kami menyediakan peluang investasi menarik bagi para
                                investor yang ingin berpartisipasi dalam perkembangan UMKM
                                dengan cara berinvestasi dalam proyek-proyek yang menjanjikan.
                                Melalui platform kami yang transparan dan aman, kami memastikan
                                setiap dana yang dikelola dengan baik dan disalurkan setelah
                                kebutuhan UMKM terpenuhi atau modal tercapai.
                            </p>
                            <p>
                                Kami menjadi kekuatan yang mendukung pengembangan proyek-proyek
                                UMKM yang inovatif, dengan visi untuk menciptakan dampak positif
                                dalam memajukan sektor UMKM secara menyeluruh. Dengan kolaborasi
                                dan kerjasama, kami berupaya mendorong pertumbuhan, memberikan
                                kesempatan, dan menginspirasi kesuksesan para pelaku usaha UMKM
                        ...
                        <Image
                            ...
                            alt="Tentang Kami Crowdfunding UMKM"
                ...
                <section className="about-section section bg-tertiary position-relative overflow-hidden">
                    ...
                    <div className="row justify-content-around">
                        ...
                        <p className="lead">
                            Kita adalah tim Crowdfunding ini, bekerja bersama untuk
                            menghubungkan investor dengan para pelaku usaha UMKM demi mendorong
                            pertumbuhan dan keberlanjutan bisnis yang sukses.
                        </p>
                        <div className="content">
                            Kita adalah tim Crowdfunding yang berkomitmen untuk menciptakan dan
                            mengelola platform Crowdfunding yang inovatif.
                        </div>
                        </div>
                        <div className="col-lg-5">
                        <div className="section-title">
                            <p className="text-primary text-uppercase fw-bold mb-3" />
                            <h2>Apa yang kita tawarkan?</h2>
                        </div>
                        <p className="lead">
                            {" "}
                            Kita memberikan kesempatan kepada investor untuk berpartisipasi
                            dalam pertumbuhan dan kesuksesan UMKM dengan cara berinvestasi dalam
                            proyek-proyek yang menarik.
                        </p>
                        <div className="content">
                            <ul>
                            <li>Peluang investasi menarik untuk pertumbuhan UMKM.</li>
                            <li>Platform Crowdfunding dengan transparansi dan keamanan.</li>
                            <li>Dukungan pada pengembangan proyek UMKM yang inovatif.</li>
                            </ul>
                        </div>
                        </div>
                    </div>
                ...
                <section className="section-sm bg-primary-light">
                    ...
                    <div className="row justify-content-center">
                        ...
                        <h3>Investasi Cepat</h3>
                        <p className="px-lg-5">
                            Awali investasi kamu pada Crowdfunding Kami.{" "}
                        </p>
                        </div>
                        <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
                        <div className="icon icon-lg bg-transparent mb-4">
                        ...
                        <h3>Dapat Informasi</h3>
                        <p className="px-lg-5">Dapatkan inforamsi terbaru tentang UMKM.</p>
                        </div>
                        <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
                        <div className="icon icon-lg bg-transparent mb-4">
                        ...
                        <h3>Dana Kembali</h3>
                        <p className="px-lg-5">Dana dikembalikan jika UMKM batal.</p>
                        </div>
                    </div>
                    </div>
                </section>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="row position-relative gy-4">
                            ...
                            <div className="block bg-white">
                                ...
                                <p className="mb-0">
                                Tim profesional pengelola dan pendukung platform.
                                </p>
                            </div>
                            </div>
                            <div className="icon-box-item col-md-6">
                            <div className="block bg-white">
                                ...
                                <h3 className="mb-3">Investor</h3>
                                <p className="mb-0">
                                Mendukung pertumbuhan UMKM dengan investasi.
                                </p>
                            </div>
                            </div>
                            <div className="icon-box-item col-md-6">
                            <div className="block bg-white">
                                ...
                                <h3 className="mb-3">Pengusaha</h3>
                                <p className="mb-0">
                                Membantu pengusaha UMKM sukses melalui crowdfunding.
                                </p>
                            </div>
                            </div>
                            <div className="icon-box-item col-md-6">
                            <div className="block bg-white">
                                ...
                                <h3 className="mb-3">Konsultan</h3>
                                <p className="mb-0">
                                Memberikan panduan sukses dalam crowdfunding.
                                </p>
                            </div>
                            </div>
                            <div className="has-shapes">
                        ...
                        <div className="section-title ps-0 ps-lg-5">
                            ...
                            <h2 className="h1">Crowdfunding UMKM</h2>
                            <div className="content">
                            <p>
                                Tujuan kami di Crowdfunding UMKM adalah memberikan dukungan dan
                                solusi bagi para pelaku usaha UMKM dalam mencapai pertumbuhan
                                dan keberhasilan. Kami berkomitmen untuk memfasilitasi akses ke
                                sumber daya keuangan yang dibutuhkan oleh UMKM melalui platform
                                crowdfunding kami yang transparan dan efektif. Dengan
                                menghubungkan antara para pengusaha UMKM dan investor, kami
                                ingin membangun hubungan saling menguntungkan yang berdampak
                                positif pada pertumbuhan ekonomi lokal.
                            </p>
                            <p>
                                Kami ingin menjadi mitra yang dapat diandalkan bagi UMKM dalam
                                memenuhi kebutuhan modal dan mendapatkan dukungan yang
                                diperlukan untuk mengembangkan bisnis mereka. Dengan tujuan ini,
                                kami berupaya untuk memajukan sektor UMKM dan berkontribusi pada
                ...
                <section className="section teams">
                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="section-title text-center">
                            <p id="team" className="text-primary text-uppercase fw-bold mb-3">
                            PERTANYAAN YANG ANDA PUNYA
                            </p>
                            <h1>Orang-Orang Di Belakang Kami</h1>
                            <p className="mb-0">
                            Orang-orang di belakang kami merupakan kekuatan pendorong
                            kesuksesan kami.
                            <br />
                            Dengan dedikasi dan komitmen mereka, kami siap menghadirkan
                    ...
                    <div className="row justify-content-center ">
                        ...
                        <div className="card bg-transparent border-0 text-center">
                            ...
                            <Image
                                loading="lazy"
                                decoding="async"
                                src="/assets/images/about/ahmad.jpg"
                                alt="Scarlet Pena"
                                className="rounded w-100"
                                width={300}
                                height={332}
