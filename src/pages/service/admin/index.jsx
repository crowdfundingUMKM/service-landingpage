import ServiceAdminLayout from '@/pages/service/admin/layout';
            ...
            <main>
                <section className="page-header bg-tertiary">
                    ...
                    <div className="row">
                        ...
                        <h2 className="mb-3 text-capitalize">Gabung Bersama Kami</h2>
                        <ul
                ...
                <section className="section-sm">
                    ...
                    <div className="row g-5">
                        ...
                        <div
                            ...
                            style={{ top: 30 }}
                        >
                            <h4 className="has-line-end">Admin</h4>
                            <nav id="TableOfContents">
                            <ul>
                                <li>
                                <a href="#bagaimana-bergabung">
                                    Bagaimana bergabung bersama kami sebagai admin
                                </a>
                                <ul>
                                    <li>
                                    <a href="#lamar-admin">Lamar sebagai admin</a>
                                    </li>
                                </ul>
                                </li>
                                <li>
                                <a href="#pengembang-admin">
                                    Sebagai pengembang admin, Anda menguasai platform
                                    Crowdfunding UMKM.
                                </a>
                                </li>
                                <li>
                                ...
                                <ul>
                                    <li>
                                    {" "}
                                    <a href="#layanan-pengembangan">
                                        Layanan Pengembang Admin Crowdfunding UMKM.
                                    </a>
                                    </li>
                                </ul>
                                </li>
                        ...
                        <div className="content">
                            <h2 id="bagaimana-bergabung">
                            Bagaimana bergabung bersama kami sebagai admin
                            </h2>
                            <p>
                            Jika Anda seorang developer yang bersemangat dalam mengembangkan
                            perangkat lunak dan ingin berkontribusi pada pertumbuhan industri
                            UMKM, kami mengundang Anda untuk bergabung bersama kami sebagai
                            developer admin pada proyek Crowdfunding UMKM. Di tim kami, Anda
                            akan memiliki kesempatan untuk berperan dalam menciptakan solusi
                            teknologi yang inovatif dan bermanfaat bagi para pelaku usaha
                            UMKM. Kemahiran Anda dalam pemrograman, pengelolaan database,
                            serta pemahaman akan keamanan sistem sangat berharga bagi
                            perkembangan aplikasi Crowdfunding kami. Bersama tim yang
                            kolaboratif, Anda dapat berkontribusi untuk menciptakan platform
                            yang aman, transparan, dan efisien guna memudahkan para pengguna
                            dalam menggalang dana untuk pertumbuhan bisnis mereka.
                            </p>
                            <p>
                            Kami menghargai semangat belajar dan kemauan untuk terus
                            berkembang dalam dunia teknologi. Bergabung dengan tim
                            Crowdfunding UMKM berarti Anda akan berada di lingkungan yang
                            mendukung eksplorasi ide dan berinovasi dalam teknologi terkini.
                            Proyek Crowdfunding UMKM ini masih dalam tahap pengembangan yang
                            menarik, dan Anda dapat berpartisipasi dalam tahap krusial dalam
                            membentuk fondasi aplikasi kami. Kami percaya keragaman pemikiran
                            dan keterampilan adalah aset berharga dalam mencapai visi kami
                            untuk mendukung para pelaku usaha UMKM dalam mencapai kesuksesan.
                            Jika Anda tertarik untuk menjadi bagian dari perjalanan kami dan
                            menghadirkan dampak positif bagi sektor UMKM, mari bergabung
                            bersama kami sebagai developer admin di proyek Crowdfunding UMKM.
                            </p>
                            <h3 id="lamar-admin">Lamar sebagai admin</h3>
                            <ul>
                            <li>
                                Kemahiran dalam pengembangan perangkat lunak dan pengalaman yang
                                relevan akan menjadi nilai tambah untuk berkontribusi dalam
                                proyek Crowdfunding UMKM.
                            </li>
                            <li>
                                Kemampuan untuk beradaptasi dengan cepat dan bekerja dalam tim
                                yang kolaboratif sangat dihargai untuk memastikan kesuksesan
                                pengembangan aplikasi.
                            </li>
                            <li>
                                Keahlian dalam mengelola database dan keamanan sistem akan
                                membantu memastikan data dan transaksi pelanggan terlindungi
                                dengan baik.
                            </li>
                            <li>
                                Kemauan untuk terus belajar dan berinovasi dalam teknologi
                                terkini akan membantu menciptakan solusi yang efisien dan
                                canggih untuk proyek Crowdfunding UMKM.
                            </li>
                            </ul>
                            <hr />
                            <h2 id="pengembang-admin">
                            Sebagai pengembang admin, Anda menguasai platform Crowdfunding
                            UMKM.
                            </h2>
                            <div
                            style={{
                            ...
                            <h3 id="layanan-pengembangan">
                            Layanan Pengembang Admin Crowdfunding UMKM.
                            </h3>
                            <ul>
                            <li>
                                Pengaktifan dan Deaktivasi Pengguna: Admin bertanggung jawab
                                dalam mengelola akses dan keanggotaan pengguna, sehingga
                                platform Crowdfunding UMKM tetap terjaga keamanannya.
                            </li>
                            <li>
                                Penanganan Masalah dan Error: Admin siap memberikan solusi cepat
                                dan tepat untuk setiap masalah atau error yang dihadapi
                                pengguna, guna memastikan pengalaman mereka tetap lancar dan
                                menyenangkan.
                            </li>
                            <li>
                                Monitoring dan Manajemen Sistem: Admin akan terus memantau
                                jalannya sistem dan kinerja platform, mengidentifikasi dan
                                mengatasi permasalahan yang mungkin timbul.
                            </li>
                            <li>
                                Kolaborasi dalam Pemeliharaan: Dalam semangat kolaboratif, admin
                                akan bekerja bersama tim lainnya untuk memelihara dan
                                mengembangkan platform Crowdfunding UMKM agar dapat memberikan
                                layanan terbaik bagi para pelaku usaha UMKM dan investor.
                            </li>
                            </ul>
                        </div>
                        {/* gabung sekarang */}
