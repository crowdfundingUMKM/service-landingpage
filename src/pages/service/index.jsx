import ServiceLayout from '@/pages/service/layout.jsx'
            ...
            <main>
                <section className="page-header bg-tertiary">
                    ...
                    <div className="row">
                        ...
                        <h2 className="mb-3 text-capitalize">Services</h2>
                        <ul
                ...
                <section className="section">
                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="section-title text-center">
                            <h1 className="mb-4">Segera Daftar Pada Kami</h1>
                            <p className="lead mb-0">Anda daftar pada aplikasi kami sebagai</p>
                        </div>
                        </div>
                    </div>
                    <div className="row justify-content-center">
                        ...
                        <div className="rounded shadow py-5 px-4">
                            ...
                            href="/service/investor"
                            >
                            View Details <i className="las la-arrow-right ms-1" />
                            </Link>
                        </div>
                        </div>
                        <div className="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                        ...
                        <div className="rounded shadow py-5 px-4">
                            ...
                            <Link className="btn btn-sm btn-outline-primary" href="/service/admin">
                            View Details <i className="las la-arrow-right ms-1" />
                            </Link>
                        </div>
                        </div>
