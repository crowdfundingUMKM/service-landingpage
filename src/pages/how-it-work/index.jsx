import HowItWorkLayout from '@/pages/how-it-work/layout';
            ...
            <main>
                <section className="page-header bg-tertiary">
                    <div className="container">
                        ...
                        <div className="col-8 mx-auto text-center">
                            <h2 className="mb-3 text-capitalize">Bagaimana Ini Bekerja</h2>
                            <ul
                            ...
                            <li className="list-inline-item">
                                / &nbsp; <a href="how-it-works.html">Bagaimana Ini Bekerja</a>
                            </li>
                            </ul>
                        </div>
                        </div>
                ...
                <section className="section">
                    ...
                    <div className="row justify-content-between align-items-center">
                        ...
                        <div className="section-title">
                            ...
                            <h1>Crowdfunding UMKM Terintegrasi Dengan Midtrans</h1>
                            <p></p>
                            <p>
                            Sistem kami di Crowdfunding UMKM bekerja dengan cara terintegrasi
                            dengan Midtrans, sebuah platform pembayaran terkemuka. Setiap
                            pembayaran yang dilakukan oleh investor langsung diteruskan
                            melalui platform kami, memastikan kelancaran transaksi. Setelah
                            melalui proses peninjauan oleh pengguna, pencairan modal dilakukan
                            secara transparan dan dana yang terkumpul dikelola dengan baik
                            oleh tim kami.{" "}
                            </p>
                            <p>
                            Integrasi dengan Midtrans memberikan keamanan dan kepercayaan
                            dalam setiap transaksi, memastikan bahwa investasi yang diberikan
                            oleh investor mendukung pertumbuhan dan kesuksesan UMKM dengan
                            efektivitas yang terjamin.
                            </p>
                            <p />
                        </div>
                        </div>
                ...
                <section className="section loan-steps bg-tertiary">
                    ...
                    <div className="row justify-content-center align-items-center">
                        ...
                        <div className="section-title text-center">
                            ...
                            <h1>Berikan Donasi Dengan Langkah-langkah Berikut</h1>
                        </div>
                        </div>
                    </div>
                    <div className="row justify-content-center">
                        ...
                        <div className="row justify-content-center">
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="mb-3">Cari UMKM yang butuh modal.</h3>
                                <p className="mb-0">
                                Temukan UMKM yang membutuhkan tambahan modal untuk
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="mb-3">Donasikan pada UMKM yang membutuhkan.</h3>
                                <p className="mb-0">
                                Berikan bantuan dengan cara mendonasikan dana kepada UMKM yang
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="mb-3">Keuntungan tahunan yang stabil.</h3>
                                <p className="mb-0">
                                Nikmati keuntungan tahunan yang konsisten dan stabil untuk
                ...
                <section className="section">
                    ...
                    <div className="row justify-content-center align-items-center">
                        ...
                        <div id="benefit" className="section-title text-center">
                            <p className="text-primary text-uppercase fw-bold mb-3">
                            PERTANYAAN YANG ANDA PUNYA
                            </p>
                            <h1>Apa yang Anda Dapatkan pada Crowdfunding </h1>
                            <p>
                            Anda akan mendapatkan crowdfunding untuk mendukung proyek Anda
                            dengan berbagai manfaat yang meliputi dana, dukungan, dan
                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="block">
                            ...
                            <h3 className="mb-3">Cepat dan nyaman</h3>
                            <p className="mb-0">
                            Nikmati kemudahan dan kecepatan dalam mendapatkan dukungan
                            crowdfunding untuk proyek UMKM Anda. Serta Manfaat Lainnya yang
                            ada pada Crowdfunding
                            </p>
                        </div>
                        </div>
                        <div className="icon-box-item col-lg-4 col-md-6">
                        <div className="block">
                            ...
                            <h3 className="mb-3">Sangat Aman dan terpercaya</h3>
                            <p className="mb-0">
                            Kami menyediakan layanan crowdfunding UMKM yang sangat aman dan
                            terpercaya, memberikan Anda kepercayaan dan ketenangan pikiran
                            dalam menjalankan proyek Anda.
                            </p>
                        </div>
                        </div>
                        <div className="icon-box-item col-lg-4 col-md-6">
                        <div className="block">
                            ...
                            <h3 className="mb-3">Dipercaya oleh pelanggan</h3>
                            <p className="mb-0">
                            Kami bangga dipercaya oleh pelanggan sebagai pilihan utama dalam
                            crowdfunding UMKM, sebagai pengelola terpercaya dengan reputasi
                            terbaik.
                            </p>
                        </div>
                        </div>
